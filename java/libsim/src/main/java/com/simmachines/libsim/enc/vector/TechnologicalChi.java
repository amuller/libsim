 ...
 * <p>
 ...
 The TechnologicalChi distance is given by the Chi distance between two vectors \(a,b\) representing the patent portfolios of two firms:
 <p>
...
public class TechnologicalChi {
	...
	/**
	 * Calculates the Technological distance (using the chi distance) between two technology patent vectors.
