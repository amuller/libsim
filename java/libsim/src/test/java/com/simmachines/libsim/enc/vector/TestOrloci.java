...
public class TestOrloci {
	...
	public void test1(){
		...
		double res = Orloci.distance(v1, v2);
		Asserts.assertEquals(res, 0.48006910221375422319);
	}
	...
	public void test2(){
		...
		Asserts.assertEqualLength(v1, v2);
		double res = Orloci.distance(v1, v2);
		Asserts.assertEquals(res, 0.59325007485782924257);
	}
	...
	public void test3(){
		...
		Asserts.assertEqualLength(v1, v2);
		double res = Orloci.distance(v1, v2);
		Asserts.assertEquals(res, 0.99264848216636084272);
	}
