...
public class TestYuleY {
	...
	public void test1(){
		...
		double res = YuleY.distance(v1, v2);
	...
	public void test3(){
		...
		Asserts.assertEqualLength(v1, v2);
		double res = YuleY.distance(v1, v2);
		Asserts.assertEquals(res, 0.414213562);
	}
	...
	public void test7(){
		...
		Asserts.assertEqualLength(v1, v2);
		double res = YuleY.distance(v1, v2);
		Asserts.assertEquals(res, 0.67962275);
	}
	...
	public void test8(){
		...
		Asserts.assertEqualLength(v1, v2);
		double res = YuleY.distance(v1, v2);
		Asserts.assertEquals(res, 0.633974);
	}
