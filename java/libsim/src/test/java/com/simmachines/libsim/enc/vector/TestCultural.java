...
public class TestCultural {
	...
	//jdsalazar
	public void test1(){
		double[] var = new double[]{3,7,5,9,6};
		double[] v1 = new double[]{8,3,7,2,5};
		double[] v2 = new double[]{9,8,4,6,1};
		double res = Cultural.distance(var, v1, v2);
	...
	//jdsalazar
	public void test2(){
		double[] var = new double[]{64,3,49,92,18};
