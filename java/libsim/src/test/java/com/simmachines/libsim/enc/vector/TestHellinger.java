...
public class TestHellinger {
	...
	public void test1(){
		...
		double res = Hellinger.distance(v1, v2);
		Asserts.assertEquals(res, 0.68779977213681889966);
	}
	...
	public void test2(){
		...
		Asserts.assertEqualLength(v1, v2);
		double res = Hellinger.distance(v1, v2);
		Asserts.assertEquals(res, 1.18241145809914240699);
	}
	...
	public void test3(){
		...
		Asserts.assertEqualLength(v1, v2);
		double res = Hellinger.distance(v1, v2);
		Asserts.assertEquals(res, 2.4039112939980751295);
	}
