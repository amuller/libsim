...
public class TestPearsonCorrelation {
	...
	public void test2() {
		...
		Asserts.assertEqualLength(v1, v2);
		double res = PearsonCorrelation.distance(v1, v2);
		Asserts.assertEquals(res, 0.010256681389212985);
	}
	...
	public void test03() {
		...
		Asserts.assertEqualLength(v1, v2);
		double res = PearsonCorrelation.distance(v1, v2);
		Asserts.assertEquals(res, 1.3546783878);
	}
	...
	public void test04() {
		...
		Asserts.assertEqualLength(v1, v2);
		double res = PearsonCorrelation.distance(v1, v2);
		Asserts.assertEquals(res, 0.8703377566);
	}
	...
	public void test05() {
		...
		Asserts.assertEqualLength(v1, v2);
		double res = PearsonCorrelation.distance(v1, v2);
		Asserts.assertEquals(res, 0.7226769102);
	}
}