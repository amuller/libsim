...
public class TestPearsonCorrelation {
	...
	public void test1() {
		...
		assertTrue(CommonCheck.Check2Doubles(res, 0.5));
	}
	...
	public void test2() {
		...
		double res = PearsonCorrelation.distance(v1, v2);
		assertTrue(CommonCheck.Check2Doubles(res, 0.010256681389212985));
	}
	...
	public void test03() {
		...
		double res = PearsonCorrelation.distance(v1, v2);
		assertTrue(CommonCheck.Check2Doubles(res, 1.3546783878));
	}
	...
	public void test04() {
		...
		double res = PearsonCorrelation.distance(v1, v2);
		assertTrue(CommonCheck.Check2Doubles(res, 0.8703377566));
	}
	...
	public void test05() {
		...
		double res = PearsonCorrelation.distance(v1, v2);
		assertTrue(CommonCheck.Check2Doubles(res, 0.7226769102));
	}
}
